...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf hstarter-node-angular-temp && mkdir starter-node-angular-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir starter-node-angular && cp -r starter-node-angular-temp/* starter-node-angular/ && rm -rf starter-node-angular', {
      cwd: '/home/ubuntu'
  });
}
